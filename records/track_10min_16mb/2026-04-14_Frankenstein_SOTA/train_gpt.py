...
class GPT(nn.Module):
    ...
    def forward(self, input_ids: Tensor, target_ids: Tensor) -> Tensor:
        ...
        for i in range(self.num_encoder_layers):
            ...
            # Depth Recurrence: Loop through layers 3, 4, and 5 twice.
            # Assuming num_encoder_layers is at least 6 (Baseline has 9 layers total, 4 encoder, 5 decoder).
            # Let's generalize it: loop the last 3 layers of the encoder if possible.
