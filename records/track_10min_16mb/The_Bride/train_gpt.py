...
class Hyperparameters:
    ...
    muon_weight_decay = float(os.environ.get("MUON_WEIGHT_DECAY", 0.095)) # bigbag WD
    ...
    ttt_epochs = int(os.environ.get("TTT_EPOCHS", 3)) # bigbag uses 3 epochs
